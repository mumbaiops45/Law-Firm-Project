...
//   {
//     q: "Can an employee challenge unlawful termination?",
//     a: "Yes, employees can challenge illegal dismissal before appropriate labour authorities with our support.",
//   },
//   {
//     q: "Do you represent clients in labour court proceedings?",
//     a: "Yes, we represent both employers and employees in industrial and service-related disputes.",
//   },
// ];
...
// // ─── PAGE ─────────────────────────────────────────────────────────────────────
// export default function EmploymentLawyerCorporate() {
//   const [openIndex, setOpenIndex] = useState(null);
...
//         {/* ── HERO ── */}
//         <section className="relative bg-[#0B0F14] text-center text-white py-32">
//           <div className="max-w-4xl mx-auto px-6">
//             <motion.h1 variants={fadeUp} initial="hidden" whileInView="show" className="text-4xl md:text-5xl font-bold mb-6">
//               Experienced Employment Lawyer in Bangalore
//             </motion.h1>
//             <motion.p variants={fadeUp} initial="hidden" whileInView="show" className="text-gray-300 text-lg mb-6 leading-relaxed">
//               We provide strategic legal representation in workplace disputes, wrongful termination, HR compliance, and labour law matters.
//             </motion.p>
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="flex flex-col sm:flex-row justify-center gap-4">
//               <Link href="/contact" className="bg-[#C9A24D] hover:bg-[#b8913d] text-black px-8 py-3 font-semibold rounded-lg transition">
//                 Book Consultation
//               </Link>
//               <Link href="tel:+919000000000" className="border-2 border-[#C9A24D] hover:bg-[#C9A24D] hover:text-black text-[#C9A24D] px-8 py-3 font-semibold rounded-lg transition">
//                 Call Now
//               </Link>
//             </motion.div>
//           </div>
//           <div className="mt-16 max-w-4xl mx-auto px-6">
//             <Image src="/employment.jpg" alt="Employment Lawyer" width={1200} height={600} className="rounded-xl object-cover w-full" />
//           </div>
//         </section>
...
//           <div className="max-w-6xl mx-auto">
//             <motion.h2 variants={fadeUp} initial="hidden" whileInView="show" className="text-3xl font-bold text-gray-900 mb-10">
//               Our Employment & Labour Law Services
//             </motion.h2>
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="grid md:grid-cols-2 gap-6">
//               {services.map((service, idx) => (
//                 <div key={idx} className="bg-white border border-gray-200 rounded-lg p-6 hover:border-[#C9A24D] transition">
//                   <span className="text-[#C9A24D] font-bold mr-2">{String(idx + 1).padStart(2, "0")}</span>
...
//                   <button onClick={() => setOpenIndex(openIndex === index ? null : index)} className="flex justify-between w-full items-center text-left">
//                     <span className="font-semibold text-gray-800">{faq.q}</span>
//                     <ChevronDown className={`w-5 h-5 transition-transform ${openIndex === index ? "rotate-180" : ""}`} />
//                   </button>
//                   <AnimatePresence>
//                     {openIndex === index && (
//                       <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3 }} className="mt-4 text-gray-600">
//                         {faq.a}
//                       </motion.div>
//                     )}
//                   </AnimatePresence>
...
//         {/* ── CTA ── */}
//         <section className="relative py-28 text-center text-white bg-[#0B0F14]">
//           <div className="max-w-3xl mx-auto px-6">
//             <h2 className="text-3xl md:text-4xl font-bold mb-6">Protect your workplace rights with experienced labour law support.</h2>
//             <Link href="/contact" className="bg-[#C9A24D] hover:bg-[#b8913d] text-black px-12 py-4 font-semibold rounded-lg transition">
//               Request Call Back
//             </Link>
...
export default function EmploymentLaw() {
  ...
  const faqData = [
    {
      question: "What types of employment disputes do you handle?",
      answer: "We handle wrongful termination, wage disputes, workplace harassment, disciplinary proceedings, industrial disputes, and labour court litigation matters."
    },
    {
      question: "Can an employee challenge unlawful termination?",
      answer: "Yes, an employee can challenge illegal dismissal before appropriate labour authorities with support from a Labour Lawyer in Bangalore."
    },
    {
      question: "Do you represent clients in labour court proceedings?",
      answer: "Yes, as a Labour Court Lawyer in Bangalore, we represent both employers and employees in industrial and service-related disputes."
    },
    {
      question: "Do companies need HR compliance advisory?",
      answer: "Yes, businesses benefit from structured guidance from an HR Compliance Lawyer Bangalore to avoid penalties, inspections, and litigation risks."
    },
    {
      question: "What remedies are available in wrongful termination cases?",
      answer: "Remedies may include reinstatement, compensation, back wages, or structured settlement depending on the facts and legal framework."
    },
    {
      question: "Do you provide ongoing legal retainership services?",
      answer: "Yes, we offer continuous employment law advisory, contract drafting, compliance audits, and dispute management support for organizations."
    }
  ];
      ...
      <main className="bg-white overflow-hidden">
        ...
        <section className="relative bg-[#0B0F14] pt-8 pb-48 text-center">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-gray-400 text-lg max-w-4xl mx-auto">
              Our firm provides strategic representation as an Employment Lawyer in Bangalore, assisting employers and employees in resolving workplace disputes and ensuring regulatory compliance.
            ...
            <div className="flex justify-center gap-6 mt-10 flex-wrap">
              ...
              <Link href="/employment-lawyer-in-bangalore/consultation">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 translate-y-1/2 bottom-0 w-full max-w-6xl px-6">
            <div className="rounded-xl overflow-hidden shadow-2xl mt-52">
              <Image
                src="/employment.jpg"
                alt="Employment Law Consultation"
                width={1400}
                height={800}
        ...
        <section className="max-w-6xl mx-auto px-6 py-20 mt-24">
          ...
          <ul className="grid md:grid-cols-2 gap-6 text-lg text-gray-700 mb-16">
            <li>▪ Employment Contract Drafting & HR Policy Advisory</li>
            <li>▪ Wrongful Termination & Disciplinary Proceedings</li>
            <li>▪ Labour Court & Industrial Tribunal Representation</li>
            <li>▪ Workplace Harassment & POSH Compliance</li>
            <li>▪ Wage, Bonus & Salary Disputes</li>
            <li>▪ Retrenchment & Layoff Advisory</li>
            <li>▪ Employee Grievance & Settlement Negotiation</li>
            <li>▪ Labour Law Compliance & Risk Assessment</li>
          </ul>

          {/* <Image
            src="/labourlaw.png"
            alt="Employment Legal Advisory"
            width={1200}
            height={600}
            className="w-full rounded-xl shadow-lg mb-16"
          /> */}

          {/* LABOUR COURT & WRONGFUL TERMINATION */}
          <h2 className="text-4xl font-semibold mb-6">
            Labour Court & Industrial Representation
          </h2>
          ...
          <div className="space-y-4 text-lg text-gray-700 mb-16">
            <p><strong>Step 1:</strong> Case Evaluation & Legal Consultation — Understanding employment terms, documentation, and applicable labour regulations.</p>
            <p><strong>Step 2:</strong> Compliance Review or Dispute Strategy Development — Designing a structured compliance advisory plan or dispute resolution strategy. We clearly explain legal risks, documentation requirements, and potential remedies before initiating proceedings.</p>
            <p><strong>Step 3:</strong> Documentation & Legal Action — Drafting notices, replies, complaints, and preparing required filings.</p>
            <p><strong>Step 4:</strong> Labour Court / Tribunal Representation & Resolution — Strong representation before labour courts, industrial tribunals, and authorities to pursue structured resolution.</p>
          </div>
