...
//   // ── FIX: accept handler reads the latest checkbox state directly ──
//   const handleAccept = () => {
//     if (!isChecked) return;
//     try {
//       sessionStorage.setItem("disclaimerShown", "true");
...
//     { name: "Family Law", href: "/family-divorce-law" },
...
//     { name: "Cheque Bounce Matters", href: "/cheque-bounce-lawyer-in-bangalore" },
//     { name: "High Court Litigation", href: "/high-court-lawyer-in-bangalore" },
...
//     { name: "Alternative Dispute Resolution (ADR)", href: "/mediation-lawyer-in-bangalore" },
...
//   const isPracticeActive = practiceAreas.some((area) => pathname.startsWith(area.href));
...
//       <nav
//         className={`fixed top-0 w-full z-50 transition-all duration-500 ${
//           isScrolled ? "bg-black shadow-lg py-3" : "bg-black/70 backdrop-blur-xl py-5"
//         }`}
//       >
//         <div className="w-full px-6 lg:px-10 flex items-center justify-between">
...
//           {/* LOGO */}
//           <Link href="/" className="flex items-center gap-3">
//             <img src="/logo2.jpg" alt="S Jain Attorneys" className="h-11" />
//             <div>
//               <div className="text-white font-semibold text-lg">
//                 S Jain <span className="text-[#C9A24D]">&amp; Attorneys</span>
//               </div>
...
//           <ul className="hidden lg:flex items-center gap-8 text-gray-300 font-medium">
//             <li>
//               <Link href="/law-firm-in-bangalore"
//                 className={`relative px-1 py-2 transition ${
//                   isActive("/law-firm-in-bangalore")
//                     ? "text-[#C9A24D] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-[#C9A24D] after:rounded"
...
//             <li>
//               <Link href="/leading-law-firm-in-bangalore"
//                 className={`relative px-1 py-2 transition ${
//                   isActive("/leading-law-firm-in-bangalore")
//                     ? "text-[#C9A24D] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-[#C9A24D] after:rounded"
//                     : "text-gray-300 hover:text-[#C9A24D]"
//                 }`}
//               >
...
//                         isActive(item.href)
//                           ? "text-[#C9A24D] font-semibold underline"
...
//             <li>
//               <Link href="/successful-case-results-in-bangalore"
//                 className={`relative px-1 py-2 transition ${
//                   isActive("/successful-case-results-in-bangalore")
//                     ? "text-[#C9A24D] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-[#C9A24D] after:rounded"
//                     : "text-gray-300 hover:text-[#C9A24D]"
//                 }`}
//               >
...
//             <li>
//               <Link href="/legal-advice-bangalore"
//                 className={`relative px-1 py-2 transition ${
//                   isActive("/legal-advice-bangalore")
//                     ? "text-[#C9A24D] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-[#C9A24D] after:rounded"
//                     : "text-gray-300 hover:text-[#C9A24D]"
//                 }`}
//               >
...
//                 className={`relative px-1 py-2 transition ${
//                   isActive("/legal-consultation-in-bangalore")
//                     ? "text-[#C9A24D] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-[#C9A24D] after:rounded"
//                     : "text-gray-300 hover:text-[#C9A24D]"
//                 }`}
//               >
...
//         {/* ─────────────── MOBILE MENU ─────────────── */}
//         {mobileMenuOpen && (
//           <div className="lg:hidden bg-black border-t border-gray-800 text-white">
//             <Link href="/law-firm-in-bangalore" onClick={() => setMobileMenuOpen(false)}
//               className={`block px-6 py-4 border-b border-gray-800 transition ${isActive("/law-firm-in-bangalore") ? "text-[#C9A24D] font-semibold" : ""}`}
//             >
//               Home
//             </Link>

//             <Link href="/leading-law-firm-in-bangalore" onClick={() => setMobileMenuOpen(false)}
//               className={`block px-6 py-4 border-b border-gray-800 transition ${isActive("/leading-law-firm-in-bangalore") ? "text-[#C9A24D] font-semibold" : ""}`}
//             >
//               About
//             </Link>
...
//             <button
//               onClick={() => setMobileServicesOpen(!mobileServicesOpen)}
//               className={`w-full flex justify-between px-6 py-4 border-b border-gray-800 transition ${isPracticeActive ? "text-[#C9A24D] font-semibold" : "text-white"}`}
//             >
...
//             <Link href="/successful-case-results-in-bangalore" onClick={() => setMobileMenuOpen(false)}
//               className={`block px-6 py-4 border-b border-gray-800 transition ${isActive("/successful-case-results-in-bangalore") ? "text-[#C9A24D] font-semibold" : ""}`}
//             >
//               Success Stories
//             </Link>

//             <Link href="/legal-advice-bangalore" onClick={() => setMobileMenuOpen(false)}
//               className={`block px-6 py-4 border-b border-gray-800 transition ${isActive("/legal-advice-bangalore") ? "text-[#C9A24D] font-semibold" : ""}`}
//             >
//               Insights
//             </Link>

//             <Link href="/legal-consultation-in-bangalore" onClick={() => setMobileMenuOpen(false)}
//               className={`block px-6 py-4 transition ${isActive("/legal-consultation-in-bangalore") ? "text-[#C9A24D] font-semibold" : ""}`}
//             >
//               Contact
//             </Link>
//           </div>
...
//             {/* Header */}
//             <div className="p-6 text-center border-b">
//               <img src="/logo2.jpg" alt="S Jain Attorneys" className="h-12 mx-auto mb-3" />
//               <h2 className="text-2xl font-semibold text-black">Disclaimer &amp; Confirmation</h2>
//               <div className="w-16 h-[2px] bg-[#C9A24D] mx-auto mt-3" />
//             </div>
...
//               </p>
//               <p>
//                 By proceeding further, you acknowledge that you are accessing this website of{" "}
//                 <strong>S Jain &amp; Attorneys</strong> on your own accord and that there has been no
//                 solicitation, advertisement, or inducement by the firm or any of its members.
//               </p>
//               <p>
//                 The content provided on this website is for general informational purposes only and does
//                 not constitute legal advice. Viewing or using this website does not create an
//                 attorney-client relationship. <strong>S Jain &amp; Attorneys</strong> does not guarantee
//                 the accuracy, completeness, or outcome of any legal matter.
//               </p>
//               <p className="font-medium text-black">
//                 By clicking &ldquo;Accept &amp; Continue&rdquo;, you confirm that you have read and
//                 understood this disclaimer and agree to the terms stated herein.
//               </p>
//             </div>

//             {/* ── FIX: onChange updates state synchronously; button reads isChecked correctly ── */}
//             <div className="px-6 pb-2">
...
//                 onClick={handleAccept}
//                 disabled={!isChecked}
//                 className={`px-8 py-3 font-semibold rounded transition-all duration-300 ${
//                   isChecked
//                     ? "bg-[#C9A24D] text-black hover:bg-[#b8963e] cursor-pointer"
//                     : "bg-gray-300 text-gray-500 cursor-not-allowed"
//                 }`}
...
export default function Navbar() {
  ...
  const handleAccept = () => {
    ...
    // Immediately hide via DOM — no waiting for React re-render
    const modal = document.getElementById("disclaimer-modal");
    if (modal) modal.style.display = "none";
    document.body.style.overflow = "";
    try { sessionStorage.setItem("disclaimerShown", "true"); } catch (_) {}
    setShowDisclaimer(false);
  };
  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed inset-0 z-[9999] items-center justify-center bg-black/80 backdrop-blur-sm">
          <div className="bg-white max-w-xl w-full mx-4 rounded-lg shadow-2xl overflow-hidden">
