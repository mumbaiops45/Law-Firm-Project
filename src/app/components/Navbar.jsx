...
export default function Navbar() {
  ...
  // Function to detect if a page is active
  const isActive = (href) => pathname === href || pathname.startsWith(href + "/");

  // Check if any Practice Area is active (for dropdown parent)
      ...
      >
        <div className="w-full px-6 lg:px-10 flex items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center gap-8 text-gray-300 font-medium">
            ...
            <li>
              <Link
                href="/leading-law-firm-in-bangalore"
                className={`relative px-1 py-2 transition ${
            ...
            <li>
              <Link
                href="/successful-case-results-in-bangalore"
                className={`relative px-1 py-2 transition ${
          ...
          <div className="lg:hidden bg-black border-t border-gray-800 text-white">
            <Link
              ...
              className={`block px-6 py-4 border-b border-gray-800 transition ${
                isActive("/law-firm-in-bangalore") ? "text-[#C9A24D] font-semibold underline" : ""
              }`}
            >
              Home
            </Link>
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`block px-6 py-4 border-b border-gray-800 transition ${
                isActive("/leading-law-firm-in-bangalore") ? "text-[#C9A24D] font-semibold underline" : ""
              }`}
            >
              About
            </Link>
            ...
            <button
              onClick={() => setMobileServicesOpen(!mobileServicesOpen)}
              className={`w-full flex justify-between px-6 py-4 border-b border-gray-800 transition ${
                isPracticeActive ? "text-[#C9A24D] font-semibold underline" : "text-white"
              }`}
            >
                ...
                {practiceAreas.map((item, i) => (
                  <Link
                    ...
                    className={`block px-10 py-3 border-b border-gray-800 transition ${
                      isActive(item.href) ? "text-[#C9A24D] font-semibold underline" : "text-white"
                    }`}
                  >
                    {item.name}
                  </Link>
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`block px-6 py-4 border-b border-gray-800 transition ${
                isActive("/lawyers-in-bangalore") ? "text-[#C9A24D] font-semibold underline" : ""
              }`}
            >
              Our Team
            </Link>
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`block px-6 py-4 border-b border-gray-800 transition ${
                isActive("/successful-case-results-in-bangalore") ? "text-[#C9A24D] font-semibold underline" : ""
              }`}
            >
              Success Stories
            </Link>
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`block px-6 py-4 border-b border-gray-800 transition ${
                isActive("/legal-advice-bangalore") ? "text-[#C9A24D] font-semibold underline" : ""
              }`}
            >
              Insights
            </Link>
            ...
            <Link
              ...
              className={`block px-6 py-4 transition ${
                isActive("/legal-consultation-in-bangalore") ? "text-[#C9A24D] font-semibold underline" : ""
              }`}
            >
              Contact
            </Link>
