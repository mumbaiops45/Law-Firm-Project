      ...
      <main className="bg-white overflow-hidden">
        ...
        <section className="max-w-6xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-16 mt-24">
          ...
          <div className="space-y-6 text-gray-700">
            <p><strong>Q1:</strong> What is Section 138 of the NI Act?<br />
              Section 138 deals with penalties for cheque dishonour due to insufficient funds.</p>

            <p><strong>Q2:</strong> What is the time limit for filing?<br />
              Legal notice must be sent within 30 days of dishonour.</p>

            <p><strong>Q3:</strong> Can imprisonment occur?<br />
              Yes, penalties may include fine and imprisonment.</p>

            <p><strong>Q4:</strong> Can cases be settled?<br />
              Yes, many matters can be resolved through settlement or compounding.</p>
          </div>
