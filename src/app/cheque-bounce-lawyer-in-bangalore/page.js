...
//             <p className="text-[#C9A24D] font-bold text-base tracking-wide mb-10">
//               Response within 24 hours guaranteed.
//             </p>
...
//               <Link
//                 href="/legal-consultation-in-bangalore"
//                 className="inline-block bg-[#C9A24D] text-black px-8 py-4 font-semibold text-sm tracking-wide hover:bg-[#b8913d] transition-colors duration-200 text-center"
//               >
//                 Book Confidential Consultation
//               </Link>
...
//               <a
//                 href="tel:+919000000000"
//                 className="inline-block border-2 border-[#C9A24D] text-[#C9A24D] px-8 py-4 font-semibold text-sm tracking-wide hover:bg-[#C9A24D] hover:text-black transition-colors duration-300 text-center"
//               >
//                 Call Now
//               </a>
//             </div>
...
//           <GoldDivider />
//           <div className="max-w-6xl mx-auto">
//             <motion.h3 className="text-xl font-bold text-gray-900 uppercase tracking-widest mb-8 border-l-4 border-[#C9A24D] pl-4">
//               Our Cheque Bounce Services Include
//             </motion.h3>

//             <div className="grid md:grid-cols-2 gap-5 mb-16">
//               {services.map((item, i) => (
//                 <div key={i} className="bg-white border border-gray-100 hover:border-[#C9A24D] rounded-lg p-6 flex items-start gap-4 group transition-all duration-300">
//                   <span className="text-[#C9A24D] font-black text-lg shrink-0 mt-0.5">
//                     {String(i + 1).padStart(2, "0")}
//                   </span>
//                   <div className="border-l border-gray-200 group-hover:border-[#C9A24D] pl-4 transition-colors duration-300">
//                     <p className="text-base font-semibold text-gray-800 group-hover:text-[#8a6a20] transition-colors duration-200">{item}</p>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//             <div className="space-y-8">
//               {steps.map((step, i) => (
//                 <div key={i} className="border border-[#C9A24D]/30 hover:border-[#C9A24D]/70 rounded-lg p-8 relative group transition-colors duration-300">
//                   <div className="flex gap-6 items-start">
//                     <span className="text-[#C9A24D] font-black text-3xl shrink-0 leading-none">{step.number}</span>
//                     <div className="border-l border-[#C9A24D]/30 pl-6">
...
//               {whyChoose.map((item, i) => (
//                 <div key={i} className="bg-[#f8f6f1] border border-gray-100 hover:border-[#C9A24D] rounded-lg p-6 flex items-start gap-4 group transition-all duration-300">
//                   <span className="text-[#C9A24D] font-black text-xl shrink-0 mt-0.5">✓</span>
//                   <div className="border-l border-gray-200 group-hover:border-[#C9A24D] pl-4 transition-colors duration-300">
//                     <p className="text-base font-semibold text-gray-800 group-hover:text-[#8a6a20] transition-colors duration-200">{item}</p>
//                   </div>
...
//             <div className="space-y-4">
//               {faqs.map((faq, index) => (
//                 <div key={index} className={`rounded-xl overflow-hidden border-2 transition-all duration-300 shadow-sm ${openIndex===index?"border-[#C9A24D] bg-[#fdf9f3] shadow-[0_4px_24px_rgba(201,162,77,0.15)]":"border-gray-200 bg-white hover:border-[#C9A24D]/60 hover:shadow-md"}`}>
//                   <button
//                     onClick={() => setOpenIndex(openIndex===index?null:index)}
//                     className="w-full flex justify-between items-start p-7 text-left gap-4 group"
//                     aria-expanded={openIndex===index}
//                   >
//                     <div className="flex items-start gap-4 flex-1">
//                       <span className={`shrink-0 mt-1 w-1 self-stretch rounded-full transition-colors duration-300 ${openIndex===index?"bg-[#C9A24D]":"bg-gray-200 group-hover:bg-[#C9A24D]/50"}`} />
//                       <span className={`text-base md:text-lg font-semibold transition-colors duration-200 ${openIndex===index?"text-[#8a6a20]":"text-gray-800 group-hover:text-[#C9A24D]"}`}>
//                         Q{index+1}: {faq.q}
//                       </span>
//                     </div>
...
//             <div className="flex flex-col sm:flex-row gap-4 justify-center">
//               <Link href="/legal-consultation-in-bangalore" className="bg-[#C9A24D] text-black px-8 py-4 rounded-lg font-semibold hover:scale-105 transition inline-block text-center">
//                 Book Confidential Consultation
//               </Link>
    ...
    <>
      ...
      <main className="bg-white overflow-hidden">
        ...
        <section className="relative bg-[#0B0F14] overflow-hidden">
          ...
          {/* Hero Image */}
          <div className="relative z-10 max-w-6xl mx-auto px-6 pb-16 mb-16">
            <div className="rounded-xl overflow-hidden border border-[#C9A24D]/30 shadow-2xl">
              <Image
                src="/cheque-bounce.jpg"
                alt="Cheque Bounce NI Act Cases"
        ...
        <section className="py-28 px-6 bg-[#f8f6f1]">
          <div className="max-w-6xl mx-auto">
            <SectionHeading>Our Cheque Bounce Services Include</SectionHeading>
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <div key={index} className={`rounded-xl overflow-hidden border-2 transition-all duration-300 shadow-sm ${openIndex===index?"border-[#C9A24D] bg-[#fdf9f3] shadow-[0_4px_24px_rgba(201,162,77,0.15)]":"border-gray-200 bg-white hover:border-[#C9A24D]/60 hover:shadow-md"}`}>
                  ...
                  >
                    <div className="flex items-start gap-4 flex-1">
                      <span className={`shrink-0 mt-1 w-1 self-stretch rounded-full transition-colors duration-300 ${openIndex===index?"bg-[#C9A24D]":"bg-gray-200"}`} />
