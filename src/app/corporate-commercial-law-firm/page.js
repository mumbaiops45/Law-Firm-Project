...
// //           <p className="text-gray-700 text-lg mb-16">
// //             Our experienced Commercial Contract Lawyer team drafts, reviews, and negotiates vendor agreements, service agreements, partnership contracts, franchise agreements, employment contracts, and NDAs.
// //           </p>
...
// //           <div className="space-y-6 text-lg text-gray-700 mb-16">

// //             <p><strong>Step 1:</strong> Business Assessment & Legal Consultation</p>

// //             <p>
// //               <strong>Step 2:</strong> Legal Structuring & Documentation — We clearly explain legal risks, possible outcomes, and compliance implications before proceeding.
// //             </p>
...
// //             <p><strong>Q1:</strong> Do you assist startups and SMEs?<br/>
// //             Yes, we provide tailored Corporate Law Services for businesses of all sizes.</p>

// //             <p><strong>Q2:</strong> Can you draft customized commercial contracts?<br/>
// //             Yes, our Commercial Contract Lawyer team drafts agreements aligned with your business goals.</p>

// //             <p><strong>Q3:</strong> Do you offer ongoing advisory support?<br/>
// //             Yes, we provide structured Business Legal Advisory Services for long-term compliance and growth.</p>

// //             <p><strong>Q4:</strong> Do you assist with mergers and acquisitions?<br/>
// //             Yes, we handle due diligence, structuring, and transaction documentation.</p>

// //             <p><strong>Q5:</strong> Do you assist with corporate due diligence and risk assessment?<br/>
// //             Yes, we conduct comprehensive due diligence, compliance reviews, and risk assessments.</p>

// //             <p><strong>Q6:</strong> Can you help with regulatory approvals and licensing?<br/>
// //             Yes, our Corporate & Commercial Law Firm assists businesses in obtaining regulatory approvals and licenses.</p>
...
//     },
//     {
//       question: "Do you assist with corporate due diligence and risk assessment?",
//       answer:
...
//     },
//     {
//       question: "Can you help with regulatory approvals and licensing?",
//       answer:
//         "Yes, our Corporate & Commercial Law Firm assists businesses in obtaining regulatory approvals and licenses."
//     }
//   ];
  ...
  return (
    <>
      ...
      <main className="bg-white overflow-hidden">
        ...
        <section className="relative bg-[#0B0F14] pt-8 pb-36 md:pb-52 text-center">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white mb-6"
            >
              Corporate & Commercial Law Firm in Bangalore for Businesses & Startups
            </motion.h1>
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed max-w-4xl mx-auto mt-4">
              Our Corporate & Commercial Law Firm provides comprehensive Corporate Law Services and Business Legal Advisory Services to startups, SMEs, and established enterprises.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
              ...
              <Link href="/legal-consultation-in-bangalore">
                <button className="bg-[#C9A24D] text-black px-8 py-4 rounded-lg font-semibold hover:scale-105 transition w-full sm:w-auto">
                  Book Confidential Consultation
                </button>
              </Link>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 translate-y-1/2 bottom-0 w-full max-w-6xl px-6 pointer-events-none">            <div className="rounded-xl overflow-hidden shadow-2xl mt-20 md:mt-52">
            <Image
              src="/consultation.png"
              alt="Corporate Law Consultation"
              width={1400}
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 md:py-20 mt-24">
          ...
          <ul className="grid sm:grid-cols-2 gap-4 text-base sm:text-lg text-gray-700 mb-16">
          ...
          <p className="text-gray-700 text-base sm:text-lg mb-16 leading-relaxed">
            Our experienced Commercial Contract Lawyer team drafts, reviews, and negotiates vendor agreements, service agreements, partnership contracts, franchise agreements, employment contracts, and NDAs to ensure enforceability and risk protection.
          </p>
          ...
          <div className="space-y-4 text-base sm:text-lg text-gray-700 mb-16">
          ...
          <ul className="space-y-4 text-base sm:text-lg text-gray-700 mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            {faqData.map((faq, index) => (
              ...
              <div key={index} className="border border-[#C9A24D] rounded-lg overflow-hidden">
                ...
                <button
                  onClick={() => toggleFAQ(index)}
                  className="w-full flex justify-between items-center px-5 py-4 text-left font-semibold text-base sm:text-lg bg-white hover:bg-[#C9A24D]/10 transition"
                >
