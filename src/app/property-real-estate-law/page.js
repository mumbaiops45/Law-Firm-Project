    ...
    <>
      ...
      <main className="bg-white overflow-hidden">
        ...
        {/* ================= HERO ================= */}
          ...
          <section className="relative bg-[#0B0F14] pt-8 md:pt-8 pb-28 md:pb-36">
          ...
          >
            ...
            >
              Our firm provides strategic legal support in Property & Real Estate Law matters, assisting individuals, businesses, and NRIs with secure transactions and dispute resolution.
            </motion.p>

            <motion.p
              variants={fadeUp}
              className="text-gray-400 text-base md:text-lg max-w-3xl mx-auto mt-3"
            >
              Our experienced property lawyer and real estate lawyer team ensures legally sound documentation and strong representation in Bangalore.
            </motion.p>
            ...
            <motion.p
              variants={fadeUp}
              className="text-[#C9A24D] mt-6 font-semibold"
            >
              Response within 24 hours guaranteed.
            </motion.p>
            ...
            >
              ...
              <Link
                ...
                className="bg-[#C9A24D] text-black px-8 py-3 rounded-lg font-semibold hover:scale-105 transition text-center"
              >
                Book Confidential Consultation
              </Link>
              ...
              <Link
                ...
                className="border border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-black transition text-center"
              >
                Call Now
              </Link>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          ...
          <ul className="grid md:grid-cols-2 gap-4 text-gray-700 max-w-4xl mx-auto mb-16 text-lg">
          ...
          <Image
            ...
            width={1200}
            height={600}
            className="rounded-xl shadow-lg mx-auto mb-16 w-full max-w-4xl"
          />
          ...
          <div className="space-y-6 text-gray-700 text-lg max-w-3xl mx-auto mb-16">
            ...
            <p>
              <strong>Step 2: Document Review & Risk Assessment</strong><br />
              Comprehensive verification of title, ownership, and compliance. We clearly explain legal risks, possible outcomes, and ownership implications before proceeding.
            </p>
        ...
        <section className="relative py-28 text-center text-white">
          ...
          <div className="relative max-w-4xl mx-auto px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/legal-consultation-in-bangalore"
                className="bg-[#C9A24D] text-black px-8 py-4 rounded-lg font-semibold"
              >
                Book Confidential Consultation
              </Link>
