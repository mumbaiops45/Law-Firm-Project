...
//             className="relative z-10 max-w-5xl mx-auto px-6 pt-8 pb-16 text-center"
//           >
//             {/* eyebrow */}
...
//               for Consumer Complaints &amp; Compensation Claims
//             </motion.h1>
      ...
      <main className="bg-white overflow-hidden">
        ...
        <section ref={heroRef} className="relative bg-[#0B0F14] overflow-hidden">
          ...
          >
            ...
            >
              <Link href="/legal-consultation-in-bangalore">
                <button className="w-full sm:w-auto bg-[#C9A24D] text-black px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:bg-[#b8913d] transition-all">
                  Book Confidential Consultation
                </button>
              </Link>
              <Link href="tel:+919000000000">
                <button className="w-full sm:w-auto border-2 border-[#C9A24D] text-[#C9A24D] px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:bg-[#C9A24D] hover:text-black transition-all">
                  Call Now
                </button>
              </Link>
            </motion.div>
...
<section className="py-18 px-6 max-w-6xl mx-auto text-gray-700">
  <SectionHeading>Legal Support for Consumer Protection & Disputes</SectionHeading>
  <p className="mb-4">
    Consumer rights are protected under law, and timely action is crucial. As an experienced Consumer Protection Lawyer and Consumer Forum Advocate, we guide clients through filing complaints and seeking compensation before appropriate consumer commissions.
  </p>
  <p>
    Whether you are facing service deficiencies, product issues, e-commerce fraud, or contractual disputes, our Consumer Dispute Lawyer team ensures structured legal support and effective representation.
        ...
        {/* SERVICES */}
        <section className="py-4 px-6 bg-[#f8f6f1] relative">
          <div className="max-w-6xl mx-auto">
            <SectionHeading>Our Consumer Law Services Include</SectionHeading>
            ...
            >
              {services.map((item, i) => (
                <motion.div key={i} variants={fadeLeft} custom={i * 0.1}
                  whileHover={{ x: 5, boxShadow: "0 8px 30px rgba(0,0,0,0.08)" }}
                  className="bg-white rounded-lg p-6 flex items-start gap-4 transition-all duration-300"
                >
                  <span className="font-black text-lg shrink-0 mt-0.5">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <div className="pl-4">
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/legal-consultation-in-bangalore">
                <button className="w-full sm:w-auto bg-[#C9A24D] text-black px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:scale-105 transition-all">
                  Book Confidential Consultation
                </button>
              </Link>

              <Link href="/contact">
                <button className="w-full sm:w-auto border border-white text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-semibold hover:bg-white hover:text-black transition-all">
                  Request Call Back
                </button>
              </Link>
            </div>
