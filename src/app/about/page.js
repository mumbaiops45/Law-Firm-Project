    ...
    <>
      ...
      <section className="relative w-full h-[35vh] flex items-center justify-center">
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="relative z-10 text-4xl md:text-5xl font-semibold text-[#C9A24D]"
        >
          About Us
        </motion.h1>
      ...
      <section className="bg-[#f5f5f5] py-24 px-6">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-semibold italic text-black mb-6">
              Learn About Us
              <span className="block w-40 h-[2px] bg-[#C9A24D] mt-4"></span>
            </h2>

            <p className="text-gray-700 mb-6 leading-relaxed text-lg">
              S Jain Attorneys is committed to delivering exceptional legal
              services with professionalism, integrity, and strategic excellence.
              Our firm provides tailored legal solutions designed to protect
              client interests.
            </p>

            <p className="text-gray-700 mb-8 leading-relaxed text-lg">
              With extensive legal expertise and a client-focused approach,
              we ensure reliable guidance, strong representation,
              and long-term trust.
            </p>

            <button className="bg-black text-[#C9A24D] px-8 py-3 border border-[#C9A24D] hover:bg-[#C9A24D] hover:text-black transition duration-300">
              Learn More
            </button>
          ...
          >
            ...
            <div className="relative w-full max-w-[600px] h-[400px] p-3 border-[10px] border-black shadow-2xl">
      ...
      <section className="bg-[#f1ebeb] py-24">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="bg-black text-white p-14 shadow-2xl"
          >

            <div className="h-[3px] w-20 bg-[#C9A24D] mb-6"></div>

            <h2 className="text-[#C9A24D] text-4xl font-semibold mb-6">
              Our Philosophy
            </h2>
      ...
      <section className="bg-black py-28">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-5xl font-semibold text-[#C9A24D] mb-4">
              Meet Our Team
            </h2>

            <p className="text-gray-400 max-w-2xl mx-auto">
              Our legal professionals combine experience, strategy,
              and dedication to deliver exceptional legal representation.
            </p>
          ...
          >
            ...
            {[
              ...
              },
              {
                ...
                image: "/team2.jpeg",
                description:
                  "Specialist in family law, legal advisory, and dispute resolution.",
              },
              {
                name: "Adv. Rahul Verma",
                role: "Litigation Specialist",
                image: "/team1.jpg",
                description:
                  "Focused on court litigation and protecting client rights effectively.",
              },
            ].map((member, index) => (
              ...
              <motion.div
                ...
                variants={fadeUp}
                whileHover={{ y: -12 }}
                className="bg-white/5 backdrop-blur-lg border border-white/10 shadow-2xl overflow-hidden hover:border-[#C9A24D] transition duration-500"
              >
