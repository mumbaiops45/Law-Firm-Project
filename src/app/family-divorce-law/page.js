...
// // //             >
// // //               Home <span className="mx-2">›</span>
// // //               <span className="text-[#C9A24D]">Family & Divorce Law</span>
// // //             </motion.p>
...
// // //         {/* ABOUT SERVICE */}
// // //         <section className="max-w-6xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-16">
// // //           <h2 className="text-4xl md:text-5xl font-semibold text-black mb-6">Trusted Legal Support for Family & Divorce Matters</h2>
...
// // //           <h3 className="text-3xl md:text-4xl font-semibold text-black mb-6">Our Family & Divorce Legal Services Include</h3>
...
// // //           <h3 className="text-3xl md:text-4xl font-semibold text-black mb-6">Our Approach / How We Work</h3>
// // //           <ul className="list-disc pl-6 space-y-4 text-gray-700 mb-16">
// // //             <li>Step 1: Confidential Consultation – We understand your situation and assess legal options.</li>
// // //             <li>Step 2: Case Evaluation & Strategy Planning – A clear legal strategy is designed based on your objectives. We explain legal risks, outcomes, and settlement options.</li>
// // //             <li>Step 3: Petition Filing & Documentation – Accurate preparation and filing of required legal documents.</li>
// // //             <li>Step 4: Court Representation & Resolution – Strong representation before the Family Court for fair resolution.</li>
// // //           </ul>

// // //           <h3 className="text-3xl md:text-4xl font-semibold text-black mb-6">Why Choose Our Firm</h3>
// // //           <ul className="list-disc pl-6 space-y-4 text-gray-700 mb-16">
// // //             <li>Experienced Family & Divorce Law Advocates</li>
// // //             <li>Dedicated Divorce Lawyer & Family Court Lawyer Support</li>
// // //             <li>Discreet & Confidential Case Handling</li>
...
// // //           {/* FAQ */}
// // //           <h3 className="text-3xl md:text-4xl font-semibold text-black mb-6 text-center">Frequently Asked Questions</h3>
...
// // //                 >
// // //                   {faq.q}
// // //                   <ChevronDown className={`transition-transform duration-300 ${activeIndex === i ? "rotate-180 text-[#C9A24D]" : ""}`} />
// // //                 </button>
// // //                 {activeIndex === i && (
// // //                   <div className="px-6 pb-6 text-gray-700 border-t border-[#C9A24D]/40 pt-4">{faq.a}</div>
// // //                 )}
// // //               </div>
// // //             ))}
// // //           </div>
...
// // //           <Image src="/discussion.png" alt="Family law consultation" fill className="object-cover" />
...
// //             <motion.ul variants={fadeUp} className="space-y-6 text-gray-700 mb-16">
// //               <li><strong>Q1:</strong> How long does a divorce process take? <br />The timeline depends on whether it is mutual consent or contested, and the complexity of issues involved.</li>
// //               <li><strong>Q2:</strong> What documents are required for filing divorce? <br />Marriage certificate, address proof, identity documents, income details, and supporting evidence depending on the case.</li>
// //               <li><strong>Q3:</strong> What is the role of a Family Court Lawyer? <br />A Family Court Lawyer represents you in family court proceedings, drafts petitions, negotiates settlements, and protects your legal rights.</li>
// //               <li><strong>Q4:</strong> How is child custody decided? <br />Custody decisions are based on the child’s welfare, financial stability, parental capability, and overall best interests of the child.</li>
// //               <li><strong>Q5:</strong> Can divorce be settled without a court trial? <br />Many matters can be resolved through mutual consent divorce or structured settlement negotiations.</li>
// //               <li><strong>Q6:</strong> How is alimony calculated? <br />It depends on income, financial capacity, duration of marriage, standard of living, and court discretion.</li>
// //             </motion.ul>
...
//           {/* ================= IMAGE CARDS IN NORMAL FLOW ================= */}
//           <motion.div
//             variants={fadeImage}
//             initial="hidden"
//             animate="visible"
//             className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-6 mt-10"
//           >
//             {/* FAMILY LAW CARD */}
//             <motion.div variants={fadeUp} className="rounded-xl overflow-hidden shadow-2xl bg-white">
//               <Image
